...
// หาจำนวนข้อมูลอาจารย์ทั้งหมด
$totalRecords = $pdo->query("SELECT COUNT(*) FROM teacher")->fetchColumn();
$totalPages = ceil($totalRecords / $limit);

// ดึงข้อมูลอาจารย์ตามหน้าปัจจุบัน
$stmt = $pdo->prepare("SELECT teacher_id, teacher_name FROM teacher ORDER BY teacher_id ASC LIMIT :start, :limit");
...
<body>
    ...
    <aside class="sidebar">
        <div class="nav-links">
            ...
            <a href="admin_teacher.php" class="nav-item active"><i class='bx bx-user-voice'></i> อาจารย์</a>
    ...
    <main class="main-content">
        <div class="page-header">
            <h1 class="page-title">อาจารย์ผู้สอน</h1>
        </div>
        <div class="card">
            <table>
                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="color: var(--primary); font-weight: 500;"><?= htmlspecialchars($row['teacher_id']) ?></td>
